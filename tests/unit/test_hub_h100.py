...
class HubH100Test(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        api = TapoClient(auth_credential=AuthCredential("", ""), ip_address="", protocol=self._mock_protocol)
    ...
    async def test_should_get_all_children(self):
        ...
        self._mock_protocol.send_request.side_effect = [wrap_as_tapo_response(it) for it in children]
